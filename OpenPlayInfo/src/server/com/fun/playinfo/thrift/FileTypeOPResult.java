...
public class FileTypeOPResult implements org.apache.thrift.TBase<FileTypeOPResult, FileTypeOPResult._Fields>, java.io.Serializable, Cloneable, Comparable<FileTypeOPResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FileTypeOPResult");
  ...
  static {
    schemes.put(StandardScheme.class, new FileTypeOPResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FileTypeOPResultTupleSchemeFactory());
  }

  public int retCode; // required
  public String retMsg; // required
  public List<FileType> result; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULT, new org.apache.thrift.meta_data.FieldMetaData("result", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, FileType.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FileTypeOPResult.class, metaDataMap);
  }

  public FileTypeOPResult() {
  }

  public FileTypeOPResult(
    int retCode,
    String retMsg,
    List<FileType> result)
  {
    this();
   ...
   */
  public FileTypeOPResult(FileTypeOPResult other) {
    ...
    if (other.isSetResult()) {
      List<FileType> __this__result = new ArrayList<FileType>(other.result.size());
      for (FileType other_element : other.result) {
        __this__result.add(new FileType(other_element));
      }
      this.result = __this__result;
    }
  }

  public FileTypeOPResult deepCopy() {
    return new FileTypeOPResult(this);
  }
  ...
  public FileTypeOPResult setRetCode(int retCode) {
    this.retCode = retCode;
    setRetCodeIsSet(true);
    return this;
  }
  ...
  public FileTypeOPResult setRetMsg(String retMsg) {
    this.retMsg = retMsg;
    return this;
  }
  ...
  public java.util.Iterator<FileType> getResultIterator() {
    return (this.result == null) ? null : this.result.iterator();
  }

  public void addToResult(FileType elem) {
    if (this.result == null) {
      this.result = new ArrayList<FileType>();
    }
    this.result.add(elem);
  }

  public List<FileType> getResult() {
    return this.result;
  }

  public FileTypeOPResult setResult(List<FileType> result) {
    this.result = result;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FileTypeOPResult)
      return this.equals((FileTypeOPResult)that);
    return false;
  }

  public boolean equals(FileTypeOPResult that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FileTypeOPResult other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FileTypeOPResult(");
    boolean first = true;
  ...
  private static class FileTypeOPResultStandardSchemeFactory implements SchemeFactory {
    public FileTypeOPResultStandardScheme getScheme() {
      return new FileTypeOPResultStandardScheme();
    }
  }

  private static class FileTypeOPResultStandardScheme extends StandardScheme<FileTypeOPResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FileTypeOPResult struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result = new ArrayList<FileType>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  FileType _elem10;
                  _elem10 = new FileType();
                  _elem10.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileTypeOPResult struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.result != null) {
        oprot.writeFieldBegin(RESULT_FIELD_DESC);
        {
          ...
          for (FileType _iter11 : struct.result)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class FileTypeOPResultTupleSchemeFactory implements SchemeFactory {
    public FileTypeOPResultTupleScheme getScheme() {
      return new FileTypeOPResultTupleScheme();
    }
  }

  private static class FileTypeOPResultTupleScheme extends TupleScheme<FileTypeOPResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FileTypeOPResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResult()) {
        {
          ...
          for (FileType _iter12 : struct.result)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FileTypeOPResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.result = new ArrayList<FileType>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            FileType _elem15;
            _elem15 = new FileType();
            _elem15.read(iprot);

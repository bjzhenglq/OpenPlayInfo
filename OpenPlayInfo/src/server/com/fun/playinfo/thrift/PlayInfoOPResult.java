...
public class PlayInfoOPResult implements org.apache.thrift.TBase<PlayInfoOPResult, PlayInfoOPResult._Fields>, java.io.Serializable, Cloneable, Comparable<PlayInfoOPResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PlayInfoOPResult");
  ...
  static {
    schemes.put(StandardScheme.class, new PlayInfoOPResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PlayInfoOPResultTupleSchemeFactory());
  }

  public int retCode; // required
  public String retMsg; // required
  public List<PlayInfo> result; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULT, new org.apache.thrift.meta_data.FieldMetaData("result", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, PlayInfo.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PlayInfoOPResult.class, metaDataMap);
  }

  public PlayInfoOPResult() {
  }

  public PlayInfoOPResult(
    int retCode,
    String retMsg,
    List<PlayInfo> result)
  {
    this();
   ...
   */
  public PlayInfoOPResult(PlayInfoOPResult other) {
    ...
    if (other.isSetResult()) {
      List<PlayInfo> __this__result = new ArrayList<PlayInfo>(other.result.size());
      for (PlayInfo other_element : other.result) {
        __this__result.add(new PlayInfo(other_element));
      }
      this.result = __this__result;
    }
  }

  public PlayInfoOPResult deepCopy() {
    return new PlayInfoOPResult(this);
  }
  ...
  public PlayInfoOPResult setRetCode(int retCode) {
    this.retCode = retCode;
    setRetCodeIsSet(true);
    return this;
  }
  ...
  public PlayInfoOPResult setRetMsg(String retMsg) {
    this.retMsg = retMsg;
    return this;
  }
  ...
  public java.util.Iterator<PlayInfo> getResultIterator() {
    return (this.result == null) ? null : this.result.iterator();
  }

  public void addToResult(PlayInfo elem) {
    if (this.result == null) {
      this.result = new ArrayList<PlayInfo>();
    }
    this.result.add(elem);
  }

  public List<PlayInfo> getResult() {
    return this.result;
  }

  public PlayInfoOPResult setResult(List<PlayInfo> result) {
    this.result = result;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PlayInfoOPResult)
      return this.equals((PlayInfoOPResult)that);
    return false;
  }

  public boolean equals(PlayInfoOPResult that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PlayInfoOPResult other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PlayInfoOPResult(");
    boolean first = true;
  ...
  private static class PlayInfoOPResultStandardSchemeFactory implements SchemeFactory {
    public PlayInfoOPResultStandardScheme getScheme() {
      return new PlayInfoOPResultStandardScheme();
    }
  }

  private static class PlayInfoOPResultStandardScheme extends StandardScheme<PlayInfoOPResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PlayInfoOPResult struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result = new ArrayList<PlayInfo>(_list0.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PlayInfoOPResult struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.result != null) {
        oprot.writeFieldBegin(RESULT_FIELD_DESC);
        {
          ...
          for (PlayInfo _iter3 : struct.result)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PlayInfoOPResultTupleSchemeFactory implements SchemeFactory {
    public PlayInfoOPResultTupleScheme getScheme() {
      return new PlayInfoOPResultTupleScheme();
    }
  }

  private static class PlayInfoOPResultTupleScheme extends TupleScheme<PlayInfoOPResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PlayInfoOPResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResult()) {
        {
          ...
          for (PlayInfo _iter4 : struct.result)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PlayInfoOPResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.result = new ArrayList<PlayInfo>(_list5.size);
